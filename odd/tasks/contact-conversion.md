...
5. `feat/contact-form` stacked on 4: CC-07 to CC-09. Markup, client script, copy, browser verification. Estimated 500 to 650 authored lines.
...
CC-06 on the stacked `feat/contact-endpoint`, then CC-07 to CC-09 on `feat/contact-form`.
